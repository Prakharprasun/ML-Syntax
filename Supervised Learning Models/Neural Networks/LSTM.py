...
# Reshape the data to fit the LSTM input (samples, timesteps, features)
...
plt.title('Stock Price Prediction with LSTM (TensorFlow)')
plt.xlabel('Days')
plt.ylabel('Price')
plt.legend()
plt.show()
...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        out, _ = self.lstm(x)  # Get the output of LSTM
